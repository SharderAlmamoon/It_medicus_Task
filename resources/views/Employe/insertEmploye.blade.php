        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add A Employe</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                 <form role="form" action="{{ route('employe.store') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="Employe_name">Employe Name : </label>
                        <input type="text" name="name" id="Employe_name" value="{{ old('name') }}" class="form-control" placeholder="Enter Employe Name">
                    @error('name')
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">Submit Employe</button>
                    </div>

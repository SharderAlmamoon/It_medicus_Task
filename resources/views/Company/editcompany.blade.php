              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                      <li class="nav-item">
                        <a href="{{ route('Company.index') }}" class="btn btn-sm btn-secondary ml-auto"><i class="fa fa-start"></i> Manage Company</a>
                      </li>
                    </ul>
                  </div>
              </div><!-- /.card-header -->
                ...
                <div class="tab-content p-0">
                 <form role="form" action="{{ route('Company.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="Company_name">Copany Name : </label>
                        <input type="text" name="name" id="Company_name" class="form-control" placeholder="Enter Company Name">
                    @error('name')
                     <span class="text-danger">{{ $message }}</span>
                    @enderror
                    </div>
                    <div class="form-group">
                        <label for="email">Copany Email : </label>
                        <input type="email" name="email" id="email" class="form-control" placeholder="Enter Company Email">
                    </div>
                    <div class="form-group">
                        <label for="logo">Copany Logo : </label>
                        <input type="file" name="logo" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="website">Copany Website : </label>

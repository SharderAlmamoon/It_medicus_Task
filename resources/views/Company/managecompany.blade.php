  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <!-- Left col -->
          <section class="col-lg-10 connectedSortable offset-1">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                      <li class="nav-item">
                        <a href="{{ route('Company.create') }}" class="btn btn-sm btn-success ml-auto"><i class="fa fa-plus"></i> Add Company</a>
                      </li>
                    </ul>
                  </div>
              </div><!-- /.card-header -->
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $company->email }}</td>
                                <td>
                                    <img src="{{ asset('CompanyImage/'.$company->logo) }}" height="45px" width="90px" alt="">
                                </td>
                                <td>
                                    <a href="{{ route('Company.edit',$company->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                    <a href="{{ route('company.destroy',$company->id) }}" onclick="return confirm('Are You Sure Want To Delete')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                              </tr>
                            @endforeach
                        </tbody>
